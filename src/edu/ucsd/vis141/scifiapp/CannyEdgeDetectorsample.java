...
public class CannyEdgeDetectorsample {
	...
	public CannyEdgeDetectorsample() {
		lowThreshold = 2.5f;
		highThreshold = 7.5f;
	...
	//create a new bitmap of the detected edges
	private void writeEdges(int pixels[]) {
		DataHolder.getInstance().getBitmap().setPixels(pixels, 0, 0, 0, 0, width, height);
